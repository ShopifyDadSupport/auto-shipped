...
if (window.location.pathname === '/pages/portalsubscription') {
  const fetchData = async () => {
    try {
      const response = await fetch('https://chamonixsealapp.onrender.com/subscriptionPortal/order');
...
<div class="seal-layout" style={{ paddingRight: "0em" }}>
  <div class="seal-twoThirds">
    ...
    <div class="seal-container seal-sectioned">
      ...
      <div data-editable-container="">
        <div class="seal-sub-order-placed-text">
          <span
            class="seal-t-strong"
            data-seal-t="overview_created_at_label"
          >
            Created at:
          </span>
          <span data-convert-time="" data-wg-notranslate="">
            ${entry.create_order_date}
          </span>
        </div>

        <div>
          <span class="seal-t-strong" data-seal-t="overview_status_label">
            Status:
          </span>

          <span
            class="seal-blue seal-active-status-label"
            data-seal-t="overview_status_active"
          >
            ${entry.Status}
          </span>
        </div>
        ...
        <div data-hide-on-edit="">
          ...
          <span data-seal-t-key="interval" data-seal-t-value="30 day">
            ${entry.subscription_interval_days}
          </span>
          .
        </div>
        <div data-show-on-edit="">
          <span data-seal-t="overview_interval_label">Repeats every</span>
          <select class="sls-select replaced" name="interval">
            <option
              data-seal-t-key="interval"
              data-seal-t-value="30 day"
              value="30 day"
              selected=""
            >
              30 days
        ...
        <div class="seal-edit-buttons-wrapper" style={{ right: "-1em" }}>
          <div
            class="seal-edit-button seal-button seal-button-small seal-button-plain"
            data-hide-on-edit=""
            data-action="edit"
            data-seal-t="overview_edit_button"
          >
            Edit
          </div>
          <div
            class="seal-edit-button seal-button seal-button-small seal-button-plain-red"
            data-show-on-edit=""
            data-action="cancel"
            data-seal-t="overview_cancel_editing_button"
          >
            Cancel
          </div>
          <div
            class="seal-edit-button seal-button seal-button-small"
            data-show-on-edit=""
            data-action="save"
            data-seal-t="overview_save_button"
          >
            Save
          </div>
        </div>
    ...
    <div
      id="seal-subscription-items-list-container"
      class="seal-container seal-sectioned "
      data-editable-container=""
    >
      ...
      <div id="seal-subscription-items-list" data-seal-items-count="1">
        <div
          class="seal-layout seal-separator-top"
          data-item-id="2186773"
        >
          <div class="seal-twoThirds seal-flex-grow-2">
            <span class="seal-t-strong">
              <span class="seal-product-variant-name">
                ${entry.subscription_product__title}
              </span>
              <span class="seal-x-icon">x </span>
              <span data-hide-on-edit="" class="seal-product-quantity">
                ${entry.subscription_product_Quantity}     
              </span>
              <span data-show-on-edit="">
                <input
                  name="items[2186773][quantity]"
                  class="seal-input seal-input-small"
                  value="1"
                  min="1"
                  data-seal-quantity=""
                  type="number"
          ...
          <div class="seal-oneThird seal-tar seal-sm-mt-1">
            <div>
              <span
                data-seal-format-money=""
                data-locale="en"
                data-value="88.4"
                data-currency="USD"
              >
                ${entry.subscription_total_price}
              </span>
            </div>
            ...
            <div
              ...
              data-seal-t="overview_remove_product_button"
            >
              Remove
            </div>
          </div>
      ...
      >
        <div class="seal-full seal-tac">
          <div
            class="seal-button seal-button-small"
            data-seal-add-item=""
            data-seal-t="overview_add_product_button"
          >
            Add item
          </div>
        </div>
      ...
      <div class="seal-edit-buttons-wrapper">
        ...
        <div
          ...
          data-action="cancel"
          data-seal-t="overview_cancel_editing_button"
          data-seal-cancel-editing-products=""
        >
          Cancel
        </div>
        <div
    ...
    <div class="seal-container seal-sectioned">
      <div class="seal-flex-space-between">
        <h3 data-seal-t="overview_billing_schedule_title">
          Billing schedule
        </h3>

        <div
          class="seal-place-order-now-button-wrapper seal-tac"
        ...
        >
          <div
            ...
            class="seal-edit-button seal-button seal-button-small "
            title=""
            data-action="create_charge_now"
            data-seal-t="overview_place_order_now_button"
          >
            Place order now
          </div>
        </div>
      ...
      <div class="seal-layout">
        <div class="seal-full seal-mt-15">
          <ul class="seal-billing-attempts">
            <li
              data-billing-attempt-status=""
              data-billing-attempt-skip=""
            >
              <div class="seal-layout">
                <div class="seal-oneHalf">
                  <span class="seal-sub-billing-num">#1</span>
                  <div
                    class="seal-edit-button seal-button seal-button-small seal-button-plain seal-mr-0 seal-pr-0 seal-mb-0 seal-pb-0 seal-tar seal-pl-0"
                    data-action="reschedule"
                    data-id="9303524"
                    data-time="2023-09-18T10:00:00+00:00"
                    data-type="billing_attempt"
                  >
                    <span data-seal-t="overview_reschedule_button">
                      Reschedule
                    </span>
                  </div>
                  ...
                  <div>
                    <span
                      class="seal-italic seal-subdued"
                      data-convert-time=""
                      data-wg-notranslate=""
                    >
                     ${entry.Next_Shipment_Date}
                    </span>
                  </div>
                </div>
                <div class="seal-oneHalf seal-flex-vertical-right seal-italic seal-attempt-status-label seal-medium">
                  <span
                    class="seal-subdued"
                    data-seal-t="overview_billing_schedule_scheduled_text"
                  >
                    (scheduled)
                  </span>

                  <div
                    class="seal-edit-button seal-button seal-button-small seal-button-plain seal-mr-0 seal-pr-0 seal-mb-0 seal-pb-0 seal-tar"
                    data-action="skip"
                    data-id="9303524"
                  >
                    Skip payment
  ...
  <div class="seal-oneThird">
    <div
      class="seal-container seal-sectioned seal-container-subdued seal-sub-customer"
      data-editable-container=""
    >
    ...
    <div
      class="seal-container seal-sectioned seal-container-subdued seal-sub-contact"
      data-editable-container=""
    >
      ...
      <div>
        <div>
          <span data-hide-on-edit="">${entry.subscription_customer_email}</span>
        </div>
        <span data-show-on-edit="">
          <input
            name="email"
            class="seal-input"
            value="ggnoerr@yahoo.com"
            type="text"
          />
        </span>
      </div>
    ...
    <div
      class="seal-container seal-sectioned seal-customer-portal-shipping-card"
      data-editable-container=""
    >
      <h3 data-seal-t="overview_shipping_address_title">Shipping</h3>
      <div>
        <div>${entry.subscriptionshipping_address_first_name} ${entry.subscriptionshipping_shippingAddress_last_name}</div>
        <div>${entry.subscriptionshipping_shippingAddress_address1}</div>
        <div>${entry.subscriptionshippingAddress_zip}</div>

        <div>${entry.subscriptionshippingAddress_country}</div>
      </div>

      <div data-edit-modal-content="">
        <h3 data-seal-t="overview_shipping_address_title">Shipping</h3>
        <div class="seal-layout">
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][first_name]"
                class="seal-label"
                data-seal-t="overviewaddress_first_name_label"
              >
                First name
              </label>
              <input
                name="addresses[shipping][first_name]"
                class="seal-input seal-input-form"
                value="Gloria"
                type="text"
              />
            </div>
          ...
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][last_name]"
                class="seal-label"
                data-seal-t="overviewaddress_last_name_label"
              >
                Last name
              </label>
              <input
        ...
        <div class="seal-layout">
          <div class="seal-full">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][address1]"
                class="seal-label"
                data-seal-t="overviewaddress_address_label"
              >
                Address
              </label>
              <input
        ...
        <div class="seal-layout">
          <div class="seal-full">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][address2]"
                class="seal-label"
                data-seal-t="overviewaddress_address_line_2_label"
              >
                Apartment, suite, etc.
              </label>
              <input
        ...
        <div class="seal-layout">
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][zip]"
                class="seal-label"
                data-seal-t="overviewaddress_postal_code_label"
              >
                Postal code
              </label>
              <input
          ...
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][city]"
                class="seal-label"
                data-seal-t="overviewaddress_city_label"
              >
                City
              </label>
              <input
        ...
        <div class="seal-layout">
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][country]"
                class="seal-label"
                data-seal-t="overviewaddress_country_label"
              >
                Country/Region
              </label>

              <select
                name="addresses[shipping][country_code]"
                class="seal-input seal-input-form sls-select replaced"
                data-seal-country-selector=""
          ...
          <div class="seal-oneHalf" data-seal-hide-empty-province="">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][province]"
                class="seal-label"
                data-seal-t="overviewaddress_state_label"
              >
                State/Province
              </label>

              <select
                name="addresses[shipping][province_code]"
                class="seal-input seal-input-form sls-select replaced"
                data-seal-province-selector=""
                data-default-value="PA"
              ></select>

              <input
                name="addresses[shipping][province]"
                class="seal-input seal-input-form"
                data-seal-province-input=""
                value="Pennsylvania"
                type="hidden"
              />
            </div>
        ...
        <div class="seal-layout">
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][phone]"
                class="seal-label"
                data-seal-t="overviewaddress_phone_label"
              >
                Phone
              </label>
              <input
          ...
          <div class="seal-oneHalf">
            <div class="seal-floating-label">
              <label
                for="addresses[shipping][company]"
                class="seal-label"
                data-seal-t="overviewaddress_company_label"
              >
                Company
              </label>
              <input
      ...
      <div
        class="seal-edit-buttons-wrapper"
        data-seal-country-dependent=""
        style={{ display: "block" }}
      >
        <div
    ...
    >
      <div class="seal-layout">
        <div class="seal-twoThirds seal-tar seal-sm-mt-1">
          <div class="seal-floating-label">
            <label
              for="discount_code"
              class="seal-label"
              data-seal-t="overview_discount_code_label"
            >
              Discount code
            </label>
            <input
        ...
        <div class="seal-auto seal-tar seal-sm-mt-1">
          <div
            class="seal-button seal-button-next-to-input seal-edit-button"
            data-action="apply_discount_code"
            data-seal-t="overview_discount_code_apply_button"
          >
            Apply
          </div>
        </div>
    ...
    <div class="seal-container seal-sectioned" data-editable-container="">
      ...
      <div class="seal-layout">
        <div class="seal-auto">
          <div class="card-icon seal-card-shoppay"></div>
        </div>
        <div class="seal-full">
          <span data-seal-t="overview_payment_method_card_ending_in_text">
            Card ending in
          </span>
          1835 <br />
          <span data-seal-t="overview_payment_method_expires_on_text">
            Expires on
          </span>
          1/2026
        </div>
    ...
    <div class="seal-dynamic-sectioned">
      <div
        id="seal-pause-button"
        class="seal-button"
        data-seal-t="overview_pause_button"
      >
        Pause my subscription
      </div>

      <div
        id="seal-unsubscribe-button"
        class="seal-button seal-button-red"
        data-seal-t="overview_cancel_button"
      >
